...
using VerticalSliceArchitecture.Common.Domain;
using VerticalSliceArchitecture.Features.Todos.Domain.Envents;

namespace VerticalSliceArchitecture.Features.Todos.Domain;
